...
function Queue(url, handlers) {
  ...
  // TODO: figure out how much prefetch makes sense
...
Queue.prototype.onData = function(data) {
  logger.log({ type: 'info', msg: 'data', service: 'rabbitmq' });
  ...
  function onFail(err) {
    ...
    logger.log({ type: 'info', msg: 'acknowledging despite error', service: 'rabbitmq' });
